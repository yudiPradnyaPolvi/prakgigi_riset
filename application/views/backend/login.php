...
<div class="form-group text-center m-t-20">
		...
		<button class="btn btn-success btn-rounded btn-sm  text-uppercase" type="submit" style="color:white"><i class="fa fa-key"></i>&nbsp;<?php echo get_phrase('Reset Password');?></button>
            ...
            <label>Belum Punya Akun? Register Sekarang</label>
            <a href="<?php echo base_url();?>register"><button class="btn btn-success style1 btn-sm btn-rounded btn-block text-uppercase waves-effect waves-light" type="submit" style="width:100%; color:white ">
