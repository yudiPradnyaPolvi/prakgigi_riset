 								...
 								<table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo get_phrase('Odontogram');?></th>
                                    ...
                                    <?php $get_all_prescriptions = $this->crud_model->select_prescription_info();
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url();?>prescription/add_odontogram/<?php echo $prescription['prescription_id'];?>">
